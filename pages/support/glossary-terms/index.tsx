      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            processes have access to objects. It also defines which operations can be performed on
            specified objects. Each entry in a typical ACL specifies a subject and an operation. For
            instance, the ACL entry (Alice, delete) for a file gives Alice permission to delete the
            file.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td>Access Token</td>
          <td>An authorization mechanism created by theData Portalto access data.</td>
        </tr>
        <tr>
          <td>address pool</td>
          <td>
        ...
        <tr>
          ...
          <td>
            ...
            kernel firewall modules. Used along with iptables, ebtables, and ip6tables in Compute to
            provide firewall services for VMs.
          </td>
        </tr>
        <tr>
          <td>associate</td>
          <td>The process associating a Compute floating IP address with a fixed IP address.</td>
        </tr>
        <tr>
          <td>attach</td>
          <td>
        ...
        <tr>
          ...
          <td>Association of an interface ID to a logical port. Plugs an interface into a port.</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            mount, data transmission to an iSCSI target by a daemon, or Object Storage object
            integrity checks.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            include Object Storage, locally mounted file system, RADOS block devices, VMware
            datastore, and HTTP.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            usage is measured in bits per second.
          </td>
        </tr>
        <tr>
          <td>bits per second (BPS)</td>
          <td>The universal measurement of how quickly data is transferred from place to place.</td>
        </tr>
        <tr>
          <td>block device</td>
          <td>
        ...
        <tr>
          ...
          <td>
            ...
            with very little downtime during a user-initiated switchover. Does not require shared
            storage. Supported by Compute.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            An API on a separate endpoint for attaching, detaching, and creating block storage for
            compute VMs.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            A network protocol used by a network client to obtain an IP address from a configuration
            server. Provided in Compute through the dnsmasq daemon when using either the FlatDHCP
            manager or VLAN manager network manager.
          </td>
        </tr>
        <tr>
          <td>browser</td>
          <td>Any client software that enables a computer or device to access the Internet.</td>
        </tr>
        <tr>
          <td>Bundle ID</td>
          <td>
        ...
        <tr>
          <td>byte</td>
          <td>Set of bits that make up a single character; there are usually 8 bits to a byte.</td>
        </tr>
        <tr>
          <td>capacity cache</td>
          <td>
            A Compute back-end database table that contains the current workload, amount of free
            RAM, and number of VMs running on each host. Used to determine on which host a VM
            starts.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td>ceilometer</td>
          <td>
            Part of the OpenStack Telemetry service; gathers and stores metrics from other OpenStack
            services.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            request, instead of downloading a new, fresh set of data and comparing it against the
            old data.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            A model that enables access to a shared pool of configurable computing resources, such
            as networks, servers, storage, applications, and services, that can be rapidly
        ...
        <tr>
          ...
          <td>
            Collection of Compute components that represent the global state of the cloud; talks to
            services, such as Identity authentication, Object Storage, and node/storage workers
            through a queue.
          </td>
        </tr>
        <tr>
          ...
          <td>
            A node that runs network, volume, API, scheduler, and image services. Each service may
            be broken out into separate nodes for scalability or availability.
          </td>
        </tr>
        <tr>
          <td>cloud-init</td>
          <td>
            A package commonly installed in VM images that performs initialization of an instance
            after boot using information that it retrieves from the metadata service, such as the
            SSH public key and user data.
          </td>
        </tr>
        <tr>
          <td>cloudadmin</td>
        ...
        <tr>
          ...
          <td>
            A file sharing protocol. It is a public or open variation of the original Server Message
            Block (SMB) protocol developed and used by Microsoft. Like the SMB protocol, CIFS runs
            at a higher level and uses the TCP/IP protocol.
          </td>
        </tr>
        <tr>
          <td>compression</td>
          <td>
            Reducing the size of files by special encoding, the file can be decompressed again to
            its original content. OpenStack supports compression at the Linux file system level but
            does not support compression for things such as Object Storage objects or Image service
            VM images.
          </td>
        </tr>
        <tr>
          ...
          <td>
            The OpenStack core project that implements services and associated libraries to provide
            massively-scalable, on-demand, self-service access to compute resources, including bare
        ...
        <tr>
          ...
          <td>
            The nova-api daemon provides access to nova services. Can communicate with other APIs,
            such as the Amazon EC2 API.
          </td>
        </tr>
        <tr>
          <td>compute controller</td>
          <td>The Compute component that chooses suitable hosts on which to start VM instances.</td>
        </tr>
        <tr>
          <td>compute host</td>
        ...
        <tr>
          ...
          <td>
            ...
            process. Using conductor improves security because compute nodes do not need direct
        ...
        <tr>
          ...
          <td>
            A content delivery network is a specialized network that is used to distribute content
            to clients, typically located close to the client for increased performance.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td>core API</td>
          <td>
            Depending on context, the core API is either the OpenStack API or the main API of a
            specific core project, such as Compute, Networking, Image service, and so on.
          </td>
        </tr>
        <tr>
          <td>core service</td>
          <td>
            An official OpenStack service defined as core by DefCore Committee. Currently, consists
            of Block Storage service (cinder), Compute service (nova), Identity service (keystone),
            Image service (glance), Networking service (neutron), and Object Storage service
            (swift).
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td>credentials</td>
          <td>
            Data that is only known to or accessible by a user and used to verify that the user is
            who he says he is. Credentials are presented to the server during authentication.
        ...
        <tr>
          ...
          <td>
            A mechanism that allows many resources (for example, fonts, JavaScript) on a web page to
            be requested from another domain outside the domain from which the resource originated.
            In particular, JavaScript’s AJAX calls can use the XMLHttpRequest mechanism.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            OpenStack project which provides an extensible, unified, web-based user interface for
        ...
        <tr>
          ...
          <td>
            An integrated project that provides scalable and reliable Cloud Database-as-a-Service
        ...
        <tr>
          <td>Data Portal</td>
          <td>
            <a href="https://dcc.icgc.org/">The ICGC data portal located athttps://dcc.icgc.org.</a>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td>DCC</td>
          <td>
            The ICGC Data Coordination Center (DCC) performs quality assessment, curation and data
            releases and also manages the data flow from projects and centers to the central ICGC
            database and public repositories.
          </td>
        </tr>
        <tr>
          <td>deallocate</td>
        ...
        <tr>
          ...
          <td>
            ...
            minimize storage use—currently unsupported within OpenStack.
          </td>
        </tr>
        <tr>
          <td>default panel</td>
          <td>The default panel that is displayed when a user accesses the horizon dashboard.</td>
        </tr>
        <tr>
        ...
        <tr>
          <td>DHCP agent</td>
          <td>OpenStack Networking agent that provides DHCP services for virtual networks.</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            Governs the ability of subjects to access objects, while enabling users to make policy
            decisions and assign security attributes. The traditional UNIX system of users, groups,
        ...
        <tr>
          <td>dnsmasq</td>
          <td>Daemon that provides DNS, DHCP, BOOTP, and TFTP services for virtual networks.</td>
        </tr>
        <tr>
          <td>domain</td>
          <td>
            An Identity API v3 entity. Represents a collection of projects, groups and users that
            defines administrative boundaries for managing OpenStack Identity entities. On the
        ...
        <tr>
          ...
          <td>
            A system by which Internet domain name-to-address and address-to-name resolutions are
            determined. DNS helps navigate the Internet by translating the IP address into an
        ...
        <tr>
          <td>download</td>
          <td>The transfer of data, usually in the form of files, from one computer to another.</td>
        </tr>
        <tr>
        ...
        <tr>
          <td>durable queue</td>
          <td>A Compute RabbitMQ message queue that remains active when the server restarts.</td>
        </tr>
        <tr>
          <td>Dynamic Host Configuration Protocol (DHCP)</td>
          <td>
            A network protocol that configures devices that are connected to a network so that they
            can communicate on that network by using the Internet Protocol (IP). The protocol is
            implemented in a client-server model where DHCP clients request configuration data, such
            as an IP address, a default route, and one or more DNS server addresses from a DHCP
        ...
        <tr>
          ...
          <td>
            Pages that use HTML, JavaScript, and Cascading Style Sheets to enable users to interact
            with a web page or show simple animation.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td>ebtables</td>
          <td>
            Filtering tool for a Linux bridging firewall, enabling filtering of network traffic
            passing through a Linux bridge. Used in Compute along with arptables, iptables, and
            ip6tables to ensure isolation of network communications.
          </td>
        </tr>
        <tr>
          <td>EC2</td>
        ...
        <tr>
          ...
          <td>
            Volume that does not save the changes made to it and reverts to its original state when
        ...
        <tr>
          ...
          <td>
            Connected to by a direct consumer in RabbitMQ—Compute, the message can be consumed
        ...
        <tr>
          ...
          <td>
            File system option that enables storage of additional information beyond owner, group,
            permissions, modification time, and so on. The underlying Object Storage file system
        ...
        <tr>
          <td>extension</td>
          <td>
            Alternative term for an API extension or plug-in. In the context of Identity service,
            this is a call that is specific to the implementation, such as adding support for
            OpenID.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>A method to establish trusts between identity providers and the OpenStack cloud.</td>
        </tr>
        <tr>
          <td>Fedora</td>
        ...
        <tr>
          ...
          <td>
            A Compute networking method where the OS network configuration information is injected
        ...
        <tr>
          <td>flat network</td>
          <td>
            Virtual network type that uses neither VLANs nor tunnels to segregate project traffic.
            Each flat network typically requires a separate underlying physical interface defined by
            bridge mappings. However, a flat network can contain multiple subnets.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            public IP address each time that it boots. You create a pool of floating IP addresses
            and assign them to instances as they are launched to maintain a consistent IP address
        ...
        <tr>
          ...
          <td>
            ...
            Identity (keystone), Networking (neutron), Image service (glance), and Volumes or Block
            Storage (cinder). Folsom is the code name for the sixth release of OpenStack. The design
            summit took place in San Francisco, California, US and Folsom is a nearby city.
          </td>
        </tr>
        <tr>
          <td>FormPost</td>
        ...
        <tr>
          ...
          <td>
            <a href="https://en.wikipedia.org/wiki/Filesystem_in_Userspace">
              Filesystem in Userspaceis an operating system mechanism for Unix-like computer
        ...
        <tr>
          ...
          <td>
            Feature of certain network interface drivers that combines many smaller received packets
            into a large packet before delivery to the kernel IP stack.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>A type of image file that is commonly used for animated images on web pages.</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            Diego, California, US and Grizzly is an element of the state flag of California.
          </td>
        </tr>
        <tr>
          <td>Group</td>
        ...
        <tr>
          ...
          <td>
            ...
            several health monitors associated with it. When a pool has several monitors associated
            with it, all monitors check each member of the pool. All monitors must declare a member
            to be healthy for it to stay active.
          </td>
        </tr>
        <tr>
          <td>high availability (HA)</td>
          <td>
            A high availability system design approach and associated service implementation ensures
            that a prearranged level of operational performance will be met during a contractual
            measurement period. High availability systems seek to minimize system downtime and data
            loss.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            deployment models. Hybrid cloud can also mean the ability to connect colocation, managed
        ...
        <tr>
          ...
          <td>
            An encrypted communications protocol for secure communication over a computer network,
            with especially wide deployment on the Internet. Technically, it is not a protocol in
            and of itself; rather, it is the result of simply layering the Hypertext Transfer
            Protocol (HTTP) on top of the TLS or SSL protocol, thus adding the security capabilities
            of TLS or SSL to standard HTTP communications. Most OpenStack API endpoints and many
            inter-component communications support HTTPS communication.
          </td>
        </tr>
        <tr>
          <td>hypervisor</td>
        ...
        <tr>
          ...
          <td>
            A directory service, which allows users to login with a user name and password. It is a
        ...
        <tr>
          ...
          <td>
            The project that facilitates API client authentication, service discovery, distributed
            multi-tenant authorization, and auditing. It provides a central directory of users
            mapped to the OpenStack services they can access. It also registers endpoints for
            OpenStack services and acts as a common authentication system.
          </td>
        </tr>
        <tr>
          <td>Identity service API</td>
          <td>The API used to access the OpenStack Identity service provided through keystone.</td>
        </tr>
        <tr>
          <td>image</td>
          <td>
            A collection of files for a specific operating system (OS) that you use to create or
            rebuild a server. OpenStack provides pre-built images. You can also create custom
        ...
        <tr>
          ...
          <td>
            ...
            Storage, locally mounted file system, RADOS block devices, VMware datastore, or HTTP.
          </td>
        </tr>
        <tr>
          <td>image UUID</td>
        ...
        <tr>
          ...
          <td>
            ...
            provider owns the equipment and is responsible for housing, operating and maintaining
            it. The client typically pays on a per-use basis. IaaS is a model for providing cloud
            services.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            IOPS are a common performance measurement used to benchmark computer storage devices
            like hard disk drives, solid state drives, and storage area networks.
          </td>
        </tr>
        <tr>
          <td>instance</td>
        ...
        <tr>
          ...
          <td>
            A network protocol used by network devices for control messages. For example, ping uses
        ...
        <tr>
          ...
          <td>
            Storage protocol that encapsulates SCSI frames for transport over IP networks. Supported
            by Compute, Object Storage, and Image service.
          </td>
        </tr>
        <tr>
          <td>ironic</td>
        ...
        <tr>
          ...
          <td>
            The process of automating IP address allocation, deallocation, and management. Currently
            provided by Compute, melange, and Networking.
          </td>
        </tr>
        <tr>
          <td>ip6tables</td>
        ...
        <tr>
          ...
          <td>
            ...
            modules) and the chains and rules it stores. Different kernel modules and programs are
            currently used for different protocols: iptables applies to IPv4, ip6tables to IPv6,
        ...
        <tr>
          ...
          <td>
            IQN is the format most commonly used for iSCSI names, which uniquely identify nodes in
            an iSCSI network. All IQNs follow the pattern iqn.yyyy-mm.domain:identifier, where
            ‘yyyy-mm’ is the year and month in which the domain was registered, ‘domain’ is
            the reversed domain name of the issuing organization, and ‘identifier’ is an
            optional string which makes each IQN under the same domain unique. For example, ‘
            <a href="http://iqn.2015-10.org">iqn.2015-10.org</a>
        ...
        <tr>
          ...
          <td>
            ...
            nodes communication over a non-secure network, and allows nodes to prove their identity
        ...
        <tr>
          ...
          <td>
            ...
            x86 hardware containing virtualization extensions (Intel VT or AMD-V), ARM, IBM Power,
            and IBM zSeries. It consists of a loadable kernel module, that provides the core
        ...
        <tr>
          ...
          <td>
            The project that produces a secret storage and generation system capable of providing
            key management for services wishing to enable encryption features.
          </td>
        </tr>
        <tr>
          <td>keystone</td>
        ...
        <tr>
          ...
          <td>
            Term used in the OSI network architecture for the data link layer. The data link layer
            is responsible for media access control, flow control and detecting and possibly
        ...
        <tr>
          <td>Linux bridge</td>
          <td>Software that enables multiple VMs to share a single physical NIC within Compute.</td>
        </tr>
        <tr>
          <td>Linux Bridge neutron plug-in</td>
          <td>
            Enables a Linux bridge to understand a Networking port, interface attachment, and other
            abstractions.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>A network segment used for administration, not accessible to the public Internet.</td>
        </tr>
        <tr>
          <td>manager</td>
          <td>
        ...
        <tr>
          ...
          <td>A special Object Storage object that contains the manifest for a large object.</td>
        </tr>
        <tr>
          <td>manila</td>
          <td>OpenStack project that provides shared file systems as service to applications.</td>
        </tr>
        <tr>
          <td>manila-share</td>
          <td>
            Responsible for managing Shared File System Service devices, specifically the back-end
            devices.
          </td>
        </tr>
        <tr>
          ...
          <td>
            Maximum frame or packet size for a particular network medium. Typically 1500 bytes for
            Ethernet networks.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            opposed to basing the decision on the amount of RAM each running instance thinks it has
            available. Also known as RAM overcommit.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td>message queue</td>
          <td>
            Passes requests from clients to the appropriate workers and returns the output to the
            client after the job completes.
          </td>
        </tr>
        <tr>
          <td>Message service (zaqar)</td>
          <td>
            The project that provides a messaging service that affords a variety of distributed
            application patterns in an efficient, scalable and highly available manner, and to
            create and maintain associated Python libraries and documentation.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            node doesn’t affect VMs on other compute nodes.
          </td>
        </tr>
        <tr>
          <td>multinic</td>
        ...
        <tr>
          ...
          <td>
            Can concurrently use multiple layer-2 networking technologies, such as 802.1Q and VXLAN,
            in Networking.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            of virtual ports that share network connectivity. In Networking terminology, a network
            is always a layer-2 network.
          </td>
        </tr>
        <tr>
          <td>Network Address Translation (NAT)</td>
          <td>
            Process of modifying IP address information while in transit. Supported by Compute and
            Networking.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            Linux kernel feature that provides independent virtual networking instances on a single
            host with separate routing tables and interfaces. Similar to virtual routing and
        ...
        <tr>
          ...
          <td>
            Method of keeping a clock for a host or node correct via communication with a trusted,
        ...
        <tr>
          ...
          <td>
            ...
            Austin, Texas, US. The release is named after “Newton House” which is located at
            1013 E. Ninth St., Austin, TX. which is listed on the National Register of Historic
            Places.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            The OpenStack project which implements services and associated libraries to provide
            on-demand, scalable, and technology-agnostic network abstraction.
          </td>
        </tr>
        <tr>
          <td>Networking API (Neutron API)</td>
          <td>
            API used to access OpenStack Networking. Provides an extensible architecture to enable
        ...
        <tr>
          ...
          <td>
            Network traffic between a user or client (north) and a server (south), or traffic into
        ...
        <tr>
          ...
          <td>
            ...
            in Barcelona, Spain. Ocata is a beach north of Barcelona.
          </td>
        </tr>
        <tr>
          <td>Oldie</td>
        ...
        <tr>
          ...
          <td>
            A standardized interface for managing compute, data, and network resources, currently
        ...
        <tr>
          ...
          <td>
            ...
            programmatic extension, while still supporting standard management interfaces and
            protocols (for example NetFlow, sFlow, SPAN, RSPAN, CLI, LACP, 802.1ag).
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            networking resources throughout a data center, all managed through a dashboard that
            gives administrators control while empowering their users to provision resources through
            a web interface. OpenStack is an open source project licensed under the Apache License
            2.0.
          </td>
        </tr>
        <tr>
          ...
          <td>
            Each OpenStack release has a code name. Code names ascend in alphabetical order: Austin,
            Bexar, Cactus, Diablo, Essex, Folsom, Grizzly, Havana, Icehouse, Juno, Kilo, Liberty,
            Mitaka, Newton, Ocata, Pike, and Queens. Code names are cities or counties near where
            the corresponding OpenStack design summit took place. An exception, called the Waldon
            exception, is granted to elements of the state flag that sound especially cool. Code
        ...
        <tr>
          <td>operator</td>
          <td>The person responsible for planning and maintaining an OpenStack installation.</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            in Boston, Massachusetts, US. The release is named after the Massachusetts Turnpike,
            abbreviated commonly as the Mass Pike, which is the eastermost stretch of Interstate 90.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td>port</td>
          <td>A virtual network port within Networking; VIFs / vNICs are connected to a port.</td>
        </tr>
        <tr>
          <td>port UUID</td>
        ...
        <tr>
          ...
          <td>
            ...
            network interface. A private network interface can be a flat or VLAN network interface.
            A flat network interface is controlled by the flat_interface with flat managers. A VLAN
            network interface is controlled by the vlan_interface option with VLAN managers.
          </td>
        </tr>
        <tr>
          <td>project</td>
          <td>
            Projects represent the base unit of “ownership” in OpenStack, in that all resources
            in OpenStack should be owned by a specific project. In OpenStack Identity, a project
        ...
        <tr>
          ...
          <td>
            The Network Controller provides virtual networks to enable compute servers to interact
            with each other and with the public network. All machines must have a public and private
            network interface. The public network interface is controlled by the public_interface
            option.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            Level Agreement (SLA) between an application provider and end users. Typically includes
            performance requirements like networking bandwidth, latency, jitter correction, and
            reliability as well as storage performance in Input/Output Operations Per Second (IOPS),
            throttling agreements, and performance expectations at peak load.
          </td>
        </tr>
        <tr>
          <td>quarantine</td>
          <td>
            ...
            placed in this state, are not replicated, cannot be read by clients, and a correct copy
            is re-replicated.
          </td>
        </tr>
        <tr>
          <td>Queens</td>
          <td>
            The code name for the seventeenth release of OpenStack. The design summit will take
            place in Sydney, Australia. The release is named after the Queens Pound river in the
        ...
        <tr>
          ...
          <td>
            Ceph component that enables a Linux block device to be striped over multiple distributed
            data stores.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            The ability to start new VM instances based on the actual memory usage of a host, as
            opposed to basing the decision on the amount of RAM each running instance thinks it has
            available. Also known as memory overcommit.
          </td>
        </tr>
        <tr>
          <td>rate limit</td>
        ...
        <tr>
          <td>rebalance</td>
          <td>
            The process of distributing Object Storage partitions across all drives in the ring;
        ...
        <tr>
          ...
          <td>
            ...
            that the reboot action has completed successfully, even in cases in which the underlying
        ...
        <tr>
          ...
          <td>
            ...
            There are several types of DNS records. Each record type contains particular information
            used to describe the purpose of that record. Examples include mail exchange (MX)
            records, which specify the mail server for a particular domain; and name server (NS)
        ...
        <tr>
          <td>region</td>
          <td>
            A discrete OpenStack environment with dedicated API endpoints that typically shares only
            the Identity (keystone) with other regions.
          </td>
        </tr>
        <tr>
          <td>registry</td>
        ...
        <tr>
          <td>replicator</td>
          <td>The Object Storage back-end process that creates and manages object replicas.</td>
        </tr>
        <tr>
          <td>request ID</td>
        ...
        <tr>
          ...
          <td>
            ...
            Allows an administrator to mount the file systems for an instance to correct the
            problem.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td>rootwrap</td>
          <td>
            A feature of Compute that allows the unprivileged “nova” user to run a specified
        ...
        <tr>
          ...
          <td>
            A Compute component that determines where VM instances should start. Uses modular design
            to support a variety of scheduler types.
          </td>
        </tr>
        <tr>
          <td>scoped token</td>
          <td>An Identity service API access token that is associated with a specific project.</td>
        </tr>
        <tr>
          <td>scrubber</td>
          <td>
        ...
        <tr>
          <td>secure boot</td>
          <td>
            Process whereby the system firmware validates the authenticity of the code involved in
            the boot process.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>A set of network traffic filtering rules that are applied to a Compute instance.</td>
        </tr>
        <tr>
        ...
        <tr>
          <td>share</td>
          <td>
            A remote, mountable file system in the context of the Shared File Systems. You can mount
        ...
        <tr>
          ...
          <td>
            ...
            in a group can share one or more public IPs with any other server in the group. With the
            exception of the first server in a shared IP group, servers must be launched into shared
            IP groups. A server may be a member of only one shared IP group.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            direct access to the physical device, offering improved performance over an equivalent
        ...
        <tr>
          ...
          <td>
            OpenStack project that aims to make cloud services easier to consume and integrate with
            application development process by automating the source-to-image process, and
        ...
        <tr>
          ...
          <td>
            SPICE provides remote desktop access to guest virtual machines. It is an alternative to
        ...
        <tr>
          ...
          <td>
            The Compute VM scheduling algorithm that attempts to start a new VM on the host with the
            least amount of load.
          </td>
        </tr>
        <tr>
          <td>SQL-Alchemy</td>
        ...
        <tr>
          <td>stack</td>
          <td>
            A set of OpenStack resources created and managed by the Orchestration service according
            to a given template (either an AWS CloudFormation template or a Heat Orchestration
            Template (HOT)).
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            The method that a service uses for persistent storage, such as iSCSI, NFS, or local
            disk.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            Collective name for the Object Storage object services, container services, and account
            services.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            to delegate domains. Subdomains can themselves have subdomains, so third-level,
        ...
        <tr>
          <td>swauth</td>
          <td>
            An authentication and authorization service for Object Storage, implemented through WSGI
            middleware; uses Object Storage itself as the persistent backing store.
          </td>
        </tr>
        <tr>
          <td>swift</td>
        ...
        <tr>
          <td>sysadmin</td>
          <td>
            One of the default roles in the Compute RBAC system. Enables a user to add other users
            to a project, interact with VM images that are associated with the project, and start
        ...
        <tr>
          ...
          <td>
            The OpenStack project which collects measurements of the utilization of the physical and
            virtual resources comprising deployed clouds, persists this data for subsequent
        ...
        <tr>
          ...
          <td>
            ...
            perform authentication and authorization. Frequently used in testing and development.
          </td>
        </tr>
        <tr>
          <td>Tempest</td>
        ...
        <tr>
          ...
          <td>An Identity service API endpoint that is associated with one or more projects.</td>
        </tr>
        <tr>
          <td>tenant ID</td>
        ...
        <tr>
          <td>token</td>
          <td>An alpha-numeric string of text used to access OpenStack APIs and resources.</td>
        </tr>
        <tr>
          <td>Token Manager</td>
        ...
        <tr>
          <td>tombstone</td>
          <td>
            Used to mark Object Storage objects that have been deleted; ensures that the object is
            not updated on another node after it has been deleted.
          </td>
        </tr>
        <tr>
          <td>topic publisher</td>
          <td>
            A process that is created when a RPC call is executed; used to push the message to the
            topic exchange.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>A message that is stored in memory and is lost after the server is restarted.</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            specific domain. In OpenStack Compute, a user can be associated with roles, projects, or
            both.
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            access this data through the metadata service or config drive. Commonly used to pass a
            shell script that the instance runs on boot.
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>Method to access VM instance consoles using a web browser. Supported by Compute.</td>
        </tr>
        <tr>
          <td>VMware API</td>
        ...
        <tr>
          <td>volume</td>
          <td>
            Disk-based data storage generally represented as an iSCSI target with a file system that
        ...
        <tr>
          ...
          <td>A Block Storage component that oversees and coordinates storage volume actions.</td>
        </tr>
        <tr>
          <td>volume driver</td>
        ...
        <tr>
          ...
          <td>
            ...
            particular host. For example, not enough RAM on the host, too many CPUs on the host, and
            so on.
          </td>
        </tr>
        <tr>
          <td>weight</td>
          <td>
            Used by Object Storage devices to determine which storage devices are suitable for the
            job. Devices are weighted by size.
          </td>
        </tr>
        <tr>
          <td>weighted cost</td>
        ...
        <tr>
          ...
          <td>
            The OpenStack service that provides a simple YAML-based language to write workflows
            (tasks and transition rules) and a service that allows to upload them, modify, run them
            at scale and in a highly available manner, manage and monitor workflow execution state
            and state of individual tasks.
          </td>
        </tr>
        <tr>
          <td>Xen</td>
        ...
        <tr>
          ...
          <td>
            A Block Storage volume plug-in that enables communication with the Xen Storage Manager
            API.
          </td>
        </tr>
        <tr>
